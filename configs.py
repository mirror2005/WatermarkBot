...
class Config(object):
	...
	OWNER_ID = int(os.environ.get("OWNER_ID", 1960040199))
	CAPTION = "By @VideosWaterMarkRobot"
	BOT_USERNAME = os.environ.get("BOT_USERNAME", "VideosWaterMarkRobot")
...
__Note:   If you have any issues with Adding Watermark to a Video, then please Report at [Support Group](https://t.me/jetbots_support).__

Desgined by @jettastic
"""
	PROGRESS = """
Percentage : {0}%
Done ✅: {1}
